	...
	public static void main(String[] args) {
		...
		/**	    	try catch evita q el programa termine si hay un error*/
          ...
          /** permite la ejecucuon del menu*/
		    ...
		    String[] monedas0739 = {"$200", "$500", "$1000"};	
		    int opcion0739 = JOptionPane.showOptionDialog(null, "Por favor agrege una moneda: ","Elegir monedas",JOptionPane.DEFAULT_OPTION,JOptionPane.QUESTION_MESSAGE, null, monedas0739, monedas0739[0]);			
		    if(opcion0739 == 0){
			...
			case 6:
				int confirmar0739 = JOptionPane.showConfirmDialog(null, "Desea salir del menu?", "Salir", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
			...
			default:
				...
				JOptionPane.showConfirmDialog(null, "UPS!! Valor no valido", "Error" , JOptionPane.ERROR_MESSAGE);
